...
const services = [
    { title: "Web Developer", icon: assets.web },
    { title: "React Native Developer", icon: assets.mobile },
    { title: "Backend Developer", icon: assets.backend },
    { title: "Content Creator", icon: assets.creator },
];

const technologies = [
    { name: "HTML 5", icon: assets.html },
    { name: "CSS 3", icon: assets.css },
    { name: "JavaScript", icon: assets.javascript },
    { name: "TypeScript", icon: assets.typescript },
    { name: "React JS", icon: assets.reactjs },
    { name: "Redux Toolkit", icon: assets.redux },
    { name: "Tailwind CSS", icon: assets.tailwind },
    { name: "Node JS", icon: assets.nodejs },
    { name: "MongoDB", icon: assets.mongodb },
    { name: "Three JS", icon: assets.threejs },
